...
class DashboardController extends BaseController
{
    ...
    {
        $data = $this->proyek->join('pegawai', 'pegawai.id=proyek.id_pegawai', 'left')->join('users', 'users.id_pegawai=pegawai.id')->where(['proyek.deleted_at'=> NULL, 'users.id'=>(int) session()->get('uid')])->get()->getResultObject();
