        ...
        <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="#">Daftar Pemakaian Material</a>
                    </li>
                </ol>
            </div>
...
$(document).ready(function() {
    $("#proyek").change(function() {
        ...
        var url = "<?php echo base_url('dashboard/material_lap_list')?>" + "/" + item[0];
        var table;
        if (table) {
            table.destroy();
        }
        table = $('#myTableMaterial').DataTable({
            "destroy": true,
            "responsive": false,
            "processing": true,
            "serverSide": true,
                ...
                buttons: [{
                    ...
                    customize: function(doc) {
                        ...
                        $(doc.document.body)
                            ...
                            .prepend(
                                '<div style="position:absolute; top:10; left:50;font-size:30px;">Penggunaan Material</div>'
                            )
                            .prepend(
