       ...
       <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h5 mb-0 text-gray-800">Form Update Dana Masuk</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="table-responsive p-3">
                  <div class="col-md-6">
                    <form action="<?=base_url('dashboard/dana_update')?>" method="post" style="margin-top: 10px;">
                      ...
                      <div class="form-group row">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="date" name="tgl_transaksi" class="form-control" placeholder="Tanggal Transaksi" value="<?php echo $data['tgl_transaksi']; ?>">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="keterangan" class="form-control" placeholder="Keterangan" value="<?php echo $data['keterangan']; ?>">
