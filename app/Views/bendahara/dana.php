       ...
       <!-- Container Fluid-->
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <a href="<?=base_url('dashboard/dana_add')?>" class="btn btn-outline-primary btn-sm" style="margin-bottom: 10px;margin-top: -17px;"><i class="fa fa-plus"></i> Tambah</a>
        ...
        <script>
          $(document).ready(function () {
            $('#myTableDana').DataTable({ 
                ...
                "order": [],
                "ajax": {
                    "url": "<?php echo base_url('dashboard/dana_list')?>",
                    "type": "POST"
                },
                //optional
        ...
        <script type="text/javascript">
          function deleteDana(id){
              Swal.fire({
                  title: "",
                  text: "Anda yakin akan menghapus data dana masuk?",
                  type: "warning",
                  ...
                  if(res.value){
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "<?=base_url('dashboard/dana_delete')?>",
                        cache:false,
                        data: {id:id_en},
