            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="table-responsive p-3">
                  <div class="col-md-6">
                    <form action="<?=base_url('dashboard/operasional_store')?>" method="post" style="margin-top: 10px;">
                      <div class="form-group row">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="date" name="tgl_kegiatan" class="form-control" placeholder="Tanggal Kegiatan" value="<?php echo set_value('tgl_kegiatan'); ?>">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="keterangan" class="form-control" placeholder="Keterangan Kebutuhan" value="<?php echo set_value('keterangan'); ?>">
