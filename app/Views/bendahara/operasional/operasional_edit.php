                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="table-responsive p-3">
                            <div class="col-md-6">
                                <form action="<?=base_url('dashboard/operasional_update')?>" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" name="tgl_kegiatan" class="form-control"
                                                ...
                                                value="<?php echo $data['tgl_kegiatan']; ?>">
                                            <span
                                    ...
                                    <!-- <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="select2-single-placeholder2 form-control"
                                                ...
                                                <option value="">Select</option>
                                                <option value="kredit"
                                                    <?php echo $data['jenis_transaksi'] == 'kredit' ? 'selected' : '';?>>
                                                    Kredit</option>
                                                <option value="debit"
                                                    <?php echo $data['jenis_transaksi'] == 'debit' ? 'selected' : '';?>>
                                                    Debit</option>
                                            </select>
                                            <span
