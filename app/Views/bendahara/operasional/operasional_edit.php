       ...
       <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h5 mb-0 text-gray-800">Form Update Dana Operasional</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="table-responsive p-3">
                  <div class="col-md-6">
                    <form action="<?=base_url('dashboard/operasional_update')?>" method="post" style="margin-top: 10px;">
                      ...
                      <div class="form-group row">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="date" name="tgl_kegiatan" class="form-control" placeholder="Tanggal Kegiatan" value="<?php echo $data['tgl_kegiatan']; ?>">
                          <span class="text-danger"><?php if(isset($validation['tgl_kegiatan']) !='') echo $validation['tgl_kegiatan'];?></span>
                        </div>
                      </div>
                       <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <select class="select2-single-placeholder2 form-control" name="jenis_transaksi">
                              <option value="">Select</option>
                              <option value="kredit" <?php echo $data['jenis_transaksi'] == 'kredit' ? 'selected' : '';?>>Kredit</option>
                              <option value="debit" <?php echo $data['jenis_transaksi'] == 'debit' ? 'selected' : '';?>>Debit</option>
                          </select>
                          <span class="text-danger"><?php if(isset($validation['jenis_transaksi']) !='') echo $validation['jenis_transaksi'];?></span>
                        </div>
                      </div>
                       <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <div class="col-sm-12" align="right">
                          ...
                          <a href="<?=base_url('dashboard/operasional')?>" class="btn btn-outline-warning btn-sm"><i class="fa fa-undo-alt"></i> Batal</a>
                        </div>
                      </div>
                    </form>
                  </div>
