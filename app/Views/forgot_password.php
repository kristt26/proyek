							...
							<div class="card-body">
								<div class="m-sm-4">
									...
									<?php if(session()->getFlashdata('errors')!=''){ ?>
								      ...
								      <div class="alert alert-success alert-dismissible" style="margin-top: 5px;margin-bottom: -10px;">
								        <p style="line-height: 17px;margin-bottom: 0px;font-size: 15px;"><?= session()->getFlashdata('success') ?></p>
								      </div>
								      <?php } ?>
								   <br>
									<form action="<?=base_url('login/reset_password')?>" method="post" class="form-horizontal">
										...
										<div class="form-group row" style="margin-top: -10px;">
											<small><a href="<?php echo base_url();?>">Kembali Login</a></small>
										</div>
										<div style="text-align: center;margin-top: 17px;margin-bottom: -20px;">
											<button type="submit" class="btn btn-lg btn-primary" style="width: 100%;"><i class="fa fa-paper-plane"></i> Send</button>
										</div>
									</form>
								</div>
							</div>
