                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        ...
                        <div class="table-responsive p-3">
                            <a href="<?=base_url('dashboard/material_add')?>" class="btn btn-outline-primary btn-sm"
...
$(document).ready(function() {
    $('#myTableMaterial').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo base_url('dashboard/material_list')?>",
            "type": "POST"
        },
        //optional
        "lengthMenu": [
...
function deleteMaterial(id) {
    Swal.fire({
        ...
        if (res.value) {
            ...
            $.ajax({
                type: "DELETE",
                url: "<?=base_url('dashboard/material_delete')?>",
                cache: false,
                data: {
                    id: id_en
                },
