        ...
        <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="#">Daftar Penggunaan Kendaraan</a>
                    </li>
                </ol>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        ...
                        <div class="table-responsive p-3">
                            <a href="<?=base_url('dashboard/penggunaan_add')?>" class="btn btn-outline-primary btn-sm"
                            ...
                            <table class="table align-items-center table-flush" id="myTablePenggunaan">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th style="text-align: center;">Pemabakaian BBM</th>
...
$(document).ready(function() {
    $('#myTablePenggunaan').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo base_url('dashboard/penggunaan_list')?>",
            "type": "POST"
        },
        //optional
        "lengthMenu": [
...
function deletePenggunaan(id) {
    Swal.fire({
        title: "",
        text: "Anda yakin akan menghapus data penggunaan kendaraan?",
        type: "warning",
        ...
        if (res.value) {
            ...
            $.ajax({
                type: "DELETE",
                url: "<?=base_url('dashboard/penggunaan_delete')?>",
                cache: false,
                data: {
                    id: id_en
                },
