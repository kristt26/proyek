                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        ...
                        <div class="table-responsive p-3">
                            <a href="<?=base_url('dashboard/pemakaian_bbm_add')?>"
...
$(document).ready(function() {
    $('#myTablePemakaian').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo base_url('dashboard/pemakaian_bbm_list')?>",
            "type": "POST"
        },
        //optional
        "lengthMenu": [
...
function deletePemakaianBBM(id) {
    Swal.fire({
        title: "",
        text: "Anda yakin akan menghapus data pemakaian bahan bakar?",
        type: "warning",
        ...
        if (res.value) {
            ...
            $.ajax({
                type: "DELETE",
                url: "<?=base_url('dashboard/pemakaian_bbm_delete')?>",
                cache: false,
                data: {
                    id: id_en
                },
