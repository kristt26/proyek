       ...
       <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h5 mb-0 text-gray-800">Form Tambah Cabang Perusahaan</h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="table-responsive p-3">
                  <div class="col-md-6">
                    <form action="<?=base_url('dashboard/cabang_store')?>" method="post" style="margin-top: 10px;">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="alamat_cabang" class="form-control" placeholder="Alamat Cabang" value="<?php echo set_value('alamat_cabang'); ?>">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="email" name="email_cabang" class="form-control" placeholder="Email Cabang" value="<?php echo set_value('email_cabang'); ?>">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="telp_cabang" class="form-control" placeholder="Telp Cabang" value="<?php echo set_value('telp_cabang'); ?>">
