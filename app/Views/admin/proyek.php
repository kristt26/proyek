                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        ...
                        <div class="table-responsive p-3">
                            <a href="<?=base_url('dashboard/proyek_add')?>" class="btn btn-outline-primary btn-sm"
...
$(document).ready(function() {
    $('#myTableProyek').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo base_url('dashboard/proyek_list') ?>",
            "type": "POST"
        },
        //optional
        "lengthMenu": [
...
function deleteProyek(id) {
    Swal.fire({
        title: "",
        text: "Anda yakin akan menghapus data proyek?",
        type: "warning",
        ...
        if (res.value) {
            ...
            $.ajax({
                type: "DELETE",
                url: "<?=base_url('dashboard/proyek_delete')?>",
                cache: false,
                data: {
                    id: id_en
                },
