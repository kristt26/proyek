            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="table-responsive p-3">
                  <div class="col-md-6">
                    <form action="<?=base_url('dashboard/pegawai_store')?>" method="post" style="margin-top: 10px;">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          ...
                          <span class="text-danger"><?php if(isset($validation['alamat']) !='') echo $validation['alamat'];?></span>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          ...
                          <span class="text-danger"><?php if(isset($validation['tempat_lahir']) !='') echo $validation['tempat_lahir'];?></span>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          ...
                          <span class="text-danger"><?php if(isset($validation['tgl_lahir']) !='') echo $validation['tgl_lahir'];?></span>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          ...
                          <span class="text-danger"><?php if(isset($validation['email']) !='') echo $validation['email'];?></span>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="no_telp" class="col-sm-3 col-form-label">No. Telp</label>
                        <div class="col-sm-9">
                          <input type="text" name="no_telp" class="form-control" placeholder="No. Telp" value="<?php echo set_value('no_telp'); ?>">
                          <span class="text-danger"><?php if(isset($validation['no_telp']) !='') echo $validation['no_telp'];?></span>
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-sm-12" align="right">
                          <button type="submit" class="btn btn-outline-primary btn-sm"><i class="fa fa-save"></i> Simpan</button>
                          <a href="<?=base_url('dashboard/pegawai')?>" class="btn btn-outline-warning btn-sm"><i class="fa fa-undo-alt"></i> Batal</a>
                        </div>
                      </div>
                    </form>
                  </div>
