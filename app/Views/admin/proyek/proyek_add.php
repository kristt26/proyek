                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="table-responsive p-3">
                            <div class="col-md-6">
                                <form action="<?=base_url('dashboard/proyek_store')?>" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="nama_proyek" class="form-control"
                                                ...
                                                value="<?php echo set_value('nama_proyek'); ?>">
                                            <span
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="lokasi" class="form-control"
                                                placeholder="LOkasi Proyek" value="<?php echo set_value('lokasi'); ?>">
                                            <span
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="konsultan_pengawas" class="form-control"
                                                ...
                                                value="<?php echo set_value('konsultan_pengawas'); ?>">
                                            <span
